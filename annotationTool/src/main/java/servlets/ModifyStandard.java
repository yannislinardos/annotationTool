...
/**
 * Servlet implementation class ModifyStandard
 */
public class ModifyStandard extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Queries.modifyStandard(pk, name, processJson(json));


		System.out.println("Standard modified");
		request.setAttribute("check", "Standard " + name + " modified");
